...
public class AuthorizedResourceBuiltinHandlerAutoConfiguration {
    ...
    private Logger logger = LoggerFactory.getLogger(AuthorizedResourceBuiltinHandlerAutoConfiguration.class);
     ...
     * @version 0.8.0
     */
    public AuthorizedResourceBuiltinHandlerAutoConfiguration() {
    }
