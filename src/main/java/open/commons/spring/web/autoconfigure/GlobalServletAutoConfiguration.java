...
public class GlobalServletAutoConfiguration {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GlobalServletAutoConfiguration.class);
     ...
     * @version 0.8.0
     */
    public GlobalServletAutoConfiguration(ApplicationContext context, Environment environment) {
