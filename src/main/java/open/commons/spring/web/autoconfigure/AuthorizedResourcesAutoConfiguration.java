 ...
 * @author parkjunhong77@gmail.com
 */
@AutoConfiguration(after = { JacksonAutoConfiguration.class, OpenCommonsWebCoreAutoConfiguration.class, AuthorizedResourceBuiltinHandlerAutoConfiguration.class })
...
public class AuthorizedResourcesAutoConfiguration {
    ...
    @ConditionalOnBean(name = { AuthorizedResourceBuiltinHandlerAutoConfiguration.BEAN_QUALIFIER_AUTHORIZED_RESOURCE_HANDLERS })
