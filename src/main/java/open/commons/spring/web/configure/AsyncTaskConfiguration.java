...
public class AsyncTaskConfiguration implements AsyncConfigurer {
     ...
     * @version 0.8.0
     */
    public AsyncTaskConfiguration(@NotNull @Qualifier(ResourceConfiguration.CONFIGURATION_THREAD_POOL_TASK_EXECUTOR_CONFIG_ON_ASYNC) ThreadPoolTaskExecutorConfig config) {
        this.config = config;
    }
